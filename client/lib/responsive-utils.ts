...
export const RESPONSIVE_CLASSES = {
  ...
  cardGrid: "grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-3 sm:gap-4 md:gap-6",
  ...
  responsiveButtonGroup: "flex flex-col xs:flex-row md:flex-row items-stretch xs:items-center md:items-center gap-2 xs:gap-3 md:flex-shrink-0",
